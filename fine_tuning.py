...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--model_path',
        type=str,
        default='runs/May21_05-41-07_cifar10.de/resnet18_0.001_128_0.1_200_512_500_model.pth',
        help='The pretrained model path')
    
    parser.add_argument(
        '--log_dir',
        type=str,
        default='runs/May21_05-41-07_cifar10.de',
    ...
    csv_dir = os.path.join(log_dir, '{}_fine_tuning_stats.csv'.format(save_name_pre))
    model_dir = os.path.join(log_dir, '{}_fine_tuning_model.pth'.format(save_name_pre))
    fig_dir = os.path.join(log_dir, '{}_loss_acc_fine_tuning.png'.format(save_name_pre))
